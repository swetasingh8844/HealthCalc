...
export const Header: React.FC<HeaderProps> = ({ isDarkMode, toggleDarkMode }) => {
 ...
 <div className="relative shrink-0 overflow-visible" ref={calcRef}>
  ...
  <button
    onClick={() => setIsCalcDropdownOpen(o => !o)}
    className={`flex items-center gap-1 text-[19px] font-semibold transition px-3 py-2 rounded-lg whitespace-nowrap ${
...
>
  ...
  {/* Other links — also outside scroll div */}
  ...
  <button
    ...
    className="p-2 text-gray-600 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition"
